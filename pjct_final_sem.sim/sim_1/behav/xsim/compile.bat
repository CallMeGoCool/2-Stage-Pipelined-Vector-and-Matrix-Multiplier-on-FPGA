...
REM
REM Generated by Vivado on Wed Apr 22 23:03:43 +0530 2026
...
echo "xvlog --incr --relax -prj matrix_top_tb_vlog.prj"
call xvlog  --incr --relax -prj matrix_top_tb_vlog.prj -log xvlog.log
